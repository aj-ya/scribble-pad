...
import 'flexboxgrid';
import './main.css';
import './Components/Auth/assets/fontface.css';
...
//import dataJsonControlled from './examples/data.json.controlled';
import SketchField from './Components/Canvas/SketchField';
import Tools from './Components/Canvas/tools'
//import dataUrl from './examples/data.url';
...
class SketchFieldDemo extends React.Component {
  ...
  _download = () => {
    var img = this._sketch.toDataURL("image/jpeg");
    axios({
      url: img,
      method: 'GET',
      responseType: 'blob'
    ...
    //console.save(document.getElementsByTagName('canvas')[0].toDataURL('image/jpeg'), 'toDataURL.jpeg');
      ...
      <MuiThemeProvider theme={theme}>
        <div className="row" >
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <AppBar title="Scribble Pad." position="static" style={styles.appBar}>
              <Toolbar>
                <Typography variant="h5" color="inherit" style={{ flexGrow: 1}}><div>Hello</div></Typography>
                <IconButton
                  color="primary"
        ...
        <div className="row">
          ...
          <div className="col-xs-5 col-sm-5 col-md-3 col-lg-3 all-tiles">
    ...
    return (
      <div>
        <p>Drop some files here</p>
                    ...
                    <input type="file" id="img" name="img" accept="image/*" onChange={()=>{let imag=document.getElementById('img').value;document.getElementsByTagName('canvas')[0].style.background=`url(${imag})`}}></input>
                  </div>
                </CardContent>
              </Collapse>
            </Card>
